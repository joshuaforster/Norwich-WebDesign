    ...
    <div className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="rounded-lg bg-white dark:bg-gray-900 p-8 shadow-lg">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl text-center mb-8">
              ...
              {features.map((feature) => (
                <div key={feature.name} className="flex items-start">
                  <div className="mb-6 flex items-center justify-center">
                    <div className="p-4 rounded-lg dark:bg-gray-800 dark:shadow-md">
                      <img
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <dd className="mt-1 text-base leading-7 text-gray-900 dark:text-white">
                      {feature.description}
                    </dd>
                  </div>
                </div>
