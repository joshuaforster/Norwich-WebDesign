          ...
          <h1 className="mx-auto max-w-4xl font-caviar text-4xl md:text-6xl lg:text-7xl font-medium tracking-tight text-slate-900 dark:text-white">
           100% Custom{' '}
            <span className="relative whitespace-nowrap text-blue-600">
              ...
              <span className="relative dark:text-white">Website Development</span>
            </span>{' '}
              With Norwich Web Design
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 dark:text-gray-200">
            Here at Norwich Web Design, we don't use page builders or drag and drop tools, such as Wordpress, Sqauresapce or Wix. All our websites are handcoded to ensure the best results for your business. 
          </p>
