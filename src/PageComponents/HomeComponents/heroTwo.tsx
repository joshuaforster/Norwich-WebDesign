        ...
        <div className="text-center">
          <h1 className="mx-auto max-w-4xl font-caviar text-4xl lg:text-7xl font-medium tracking-tight text-slate-900 dark:text-white">
            ...
            <span className="relative whitespace-nowrap text-blue-600">
              ...
              <span className="relative">with Custom Websites</span>
            </span>{' '}
              for Norwich Trades.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 dark:text-gray-200">
            Elevate your business with a website designed to showcase your expertise and attract more clients. Serving Norwich and beyond, we build custom-coded sites that reflect the quality of your work.
          </p>
