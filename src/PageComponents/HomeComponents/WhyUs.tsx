    ...
    <div className="bg-white dark:bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-base font-semibold leading-7 text-blue-700 dark:text-white">What We Do</h2>
          ...
          <dl className="flex flex-wrap justify-center items-center gap-x-8 gap-y-16 md:grid md:grid-cols-3 md:max-w-none">
            {features.map((feature) => (
              ...
              >
                ...
                <dd className="mt-4 text-base leading-7 text-gray-600 dark:text-white">
